...
<html>
  ...
  <body ng-app="cath">
    ...
    <script src="scripts/factory/facebookFactory.js"></script>
      ...
      function testAPI() {
        ...
        FB.api('/me', function (response) {
          ...
          FB.api('/' + response.id + '/accounts', function (res) {
            console.log(res);
            var accountData = _.find(res.data, { id: '1199108503443090' });
            $.ajax('https://graph.facebook.com/1199108503443090/instant_articles?access_token=' + accountData.access_token);
          });
        });
      }
    </script>
    ...
    <fb:login-button scope="public_profile,email,pages_manage_instant_articles,pages_show_list" onlogin="checkLoginState();">
    </fb:login-button>
